...
- {id: CORE_CLK_ROOT.outFreq, value: 500 MHz, locked: true, accuracy: '0.001'}
...
- {id: GPT1_ipg_clk_highfreq.outFreq, value: 62.5/21 MHz}
- {id: GPT2_ipg_clk_highfreq.outFreq, value: 62.5/21 MHz}
- {id: IPG_CLK_ROOT.outFreq, value: 125 MHz}
- {id: LPI2C_CLK_ROOT.outFreq, value: 3 MHz}
- {id: LPSPI_CLK_ROOT.outFreq, value: 8/3 MHz}
- {id: MQS_MCLK.outFreq, value: 3 MHz}
- {id: PERCLK_CLK_ROOT.outFreq, value: 62.5/21 MHz, locked: true, accuracy: '0.001'}
...
- {id: CCM.LPSPI_PODF.scale, value: '9'}
- {id: CCM.PERCLK_PODF.scale, value: '42'}
...
void BOARD_BootClockRUN(void)
{
    ...
    /* Set PERCLK_PODF. */
    CLOCK_SetDiv(kCLOCK_PerclkDiv, 41);
    ...
    /* Set LPSPI_PODF. */
    CLOCK_SetDiv(kCLOCK_LpspiDiv, 8);
